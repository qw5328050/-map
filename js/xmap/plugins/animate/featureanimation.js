...
{	options = options || {};
	...
	this.updatePosFunction = options.updatePosFunction ? options.updatePosFunction : function(){};
	ol.Object.call(this);
};
 ...
 *	@param {string} shadow geometry for shadow (ie. style with zIndex = -1)
 *  @param rotation
 */
 ol.featureAnimation.prototype.drawGeom_ = function (e, geom, shadow, rotation)
{
    this.updatePosFunction(e.elapsed);
    var style = e.style;
	if (this.fade_)
