      ...
      <div class="comparison-trend" v-show="showChartPanel">
        ...
        <div class="comparison-content">
          ...
          <div ref="parentChart" class="chart">
            <div ref="chart" style="width: 437px;height: 294px;"></div>
          </div>
...
<script type="text/jsx">
  ...
  import trendSearchInput from './trendSearchInput.vue'
...
//      let initPDay = hour >= 20 ? now.format('YYYY-MM-DD') : now.subtract(1, 'days').format('YYYY-MM-DD')
      ...
      return {
        ...
        tabList: [{type: 'aqi', name: 'AQI'}, {type: 'pm10', name: 'PM₁₀'}, {type: 'pm25', name: 'PM₂.₅'},
           {type: 'so2', name: 'SO₂'},
    ...
    methods: {
      ...
      getChartOptions(data){
        ...
        var start = chartsStartIndex(xAxis.data.length)
        let series = [];
        data.forEach((item, index) => {
          ...
          item.resultList.forEach((valueItem, i) => {
            seryData.data.push(valueItem.value);
          })
        });
