    ...
    <div class="comparison zt-drag-dialog"
      ...
      <div class="select-region" v-show="showChoosePanel">
        ...
        <header style="cursor: move;"
                class="zt-drag-dialog-header">趋势分析
        ...
        <div class="comparison-content" style="padding:4px">
          <div class="time-pick">
            <div class="form-inline">
              ...
              <zt-dict-select :itemCode="constants.analysis_time_frequency"
          ...
          <div class="btn-wrapper">
            <a href="#" @click.stop.prevent="showChart" class="btn btn-warning">开始分析</a>
            <!-- <a href="#" @click.stop.prevent="handleClearSelected" class="btn btn-default btn-sm empty-btn">清空</a> -->
          </div>
        </div>
      </div>
      <!-- 趋势分析 -->
      <div class="comparison-trend" v-show="showChartPanel" :style="{width: comparisonTrendPanelWidth}">
        <!-- 头部区域 -->
        <header style="cursor: move;"
                class="zt-drag-dialog-header">趋势分析<a href="#"
      ...
      return {
        ...
        stationFacotrObj: {
          air: [{type: 'aqi', name: 'AQI'}, {type: 'pm10', name: 'PM₁₀'}, {type: 'pm25', name: 'PM₂.₅'}, {
            type: 'so2',
            name: 'SO₂'
          }, {type: 'no2', name: 'NO₂'}, {type: 'co', name: 'CO'}, {type: 'o3', name: 'O₃'},],
          water: [{type: 'codCr', name: '化学需氧量'}, {type: 'nh3', name: '氨氮'},
            {type: 'tp', name: '总磷'},
            {type: 'waterTemp', name: '温度'},
            {type: 'cond', name: '电导率'},
            {type: 'turb', name: '浊度'},
